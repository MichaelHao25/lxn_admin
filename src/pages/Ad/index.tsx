...
import { AdControllerFindAll } from "@/services/swagger/AdControllerFindAll";
import { AdControllerRemove } from "@/services/swagger/AdControllerRemove";
      ...
      render: (text, record, _, action) => {
        ...
        return [
          ...
          <Popconfirm
            ...
            title="确认是否删除？"
            onConfirm={async () => {
              const res = await AdControllerRemove({ _id });
              if (res.success) {
                actionRef.current?.reload();
    ...
    <>
      <ProTable
        ...
        request={async (params, sort, filter) => {
          return AdControllerFindAll(params).then((res) => {
            return {
              success: res?.success,
              data: res?.data?.list,
