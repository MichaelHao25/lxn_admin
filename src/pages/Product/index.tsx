...
import { ProductListControllerRemove } from "@/services/swagger/ProductListControllerRemove";
      ...
      render: (text, record, _, action) => {
        ...
        return [
          ...
          <Popconfirm
            ...
            title="确认是否删除？"
            onConfirm={async () => {
              const res = await ProductListControllerRemove({ _id });
              if (res.success) {
                actionRef.current?.reload();
    ...
    <>
      <ProTable
        ...
        request={async (params, sort, filter) => {
          return ProductListControllerFindAll(params).then((res) => {
            return {
              success: res?.success,
              data: res?.data?.list,
