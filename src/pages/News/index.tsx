...
import { NewsControllerFindAll } from "@/services/swagger/NewsControllerFindAll";
import { NewsControllerRemove } from "@/services/swagger/NewsControllerRemove";
      ...
      render: (text, record, _, action) => {
        ...
        return [
          ...
          <Popconfirm
            ...
            title="确认是否删除？"
            onConfirm={async () => {
              const res = await NewsControllerRemove({ _id });
              if (res.success) {
                actionRef.current?.reload();
    ...
    <>
      <ProTable
        ...
        request={async (params, sort, filter) => {
          return NewsControllerFindAll(params).then((res) => {
            return {
              success: res?.success,
              data: res?.data?.list,
